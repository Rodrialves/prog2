...
/*
*  insere no vetor o nó do grafo pretendido
*  parametro st - apontador para a estrutura criada 
*  parametro no - apontador para o nó do grafo
*  retorna a posição onde inseriu se bemsucedido ou -1 em contrário
*/
...
*  parametro: st apontador para estrutura
*  retorno: 0 se ocorrer algum erro ou 1 se bem sucedido
*/
