...
// Argumentos: lst apontador para a lista, substring string que se pretende pesquisar
...
// Argumentos:lst apontador para a lista,inserir string a inserir na lista
